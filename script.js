...
contactForm.addEventListener('submit', (e) => {
    ...
    const mailtoLink = `mailto:akilatharuka@example.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(`Name: ${name}\nEmail: ${email}\n\nMessage:\n${message}`)}`;
...
console.log('%c📧 akilatharuka@example.com', 'font-size: 12px; color: #00f2fe;');
